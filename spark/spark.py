...
class Calculator:
    def __init__(self):
        ...
        # mysql 配置
        self.prop = {'user': 'spark',
                     'password': 'Spark@123456',
                     'driver': 'com.mysql.cj.jdbc.Driver'}
        self.jdbcURL = "jdbc:mysql://192.168.130.1:3306/sql_bs" \
                       "?useUnicode=true&characterEncoding=utf-8&useSSL=false"

        #  user\rating\links\tags在hdfs中的位置 ===> 即推荐原料在hdfs中的存档路径
        self.hdfs_data_path = 'hdfs://192.168.130.130:9000/movie_system/'
